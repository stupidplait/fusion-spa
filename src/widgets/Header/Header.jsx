            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex gap-5">
                    ...
                    <NavLink className="group aspect-square flex justify-center items-center relative" to="/cart">
                        ...
                        <p className="w-5 text-xs leading-none aspect-square flex justify-center items-center absolute top-1/2 right-0 translate-x-1/2 -translate-y-1/2 rounded-full bg-stone-600">{quantity}</p>
                    </NavLink>
                </div>
            </div>
        </header>
